...
public class ViewPagerAdapter extends FragmentStateAdapter {
    ...
    public Fragment createFragment(int position) {
        if (fragmentActivity instanceof AdminHomeActivity) {
            ...
            switch (position) {
                case 0:
                    return new ClientDeviceManagementFragment(); // Fragmento para gestionar dispositivos (cliente)
                case 1:
                    return new ClientPersonalDataFragment(); // Fragmento para datos personales (cliente)
                default:
    ...
    public int getItemCount() {
        if (fragmentActivity instanceof AdminHomeActivity) {
            ...
            return 2; // Cliente: Dispositivos, Personal
        }
